		        ...
		        <div class="card-body">
		            ...
		            <div class="row">
		                <div class="col-md-12" style="margin-left: 10px;">
		                    <form name="formName" action="memberModify.lol" method="post" onsubmit="return signup();">
		                    <input type="hidden" name="memId" value="${mem.memId}">
                              ...
                              <div class="form-group row">
	                                ...
	                                <div class="col-8">
										<button type="submit" id="id_del_btn" class="btn btn-sm btn-danger pull-right" style="margin-left: 10px;" onclick="javascript: formName.action='memberDelete.lol'"><i class="far fa-trash-alt"></i>&nbsp;회원탈퇴</button>
										<button type="submit" class="btn btn-sm btn-success pull-right" onclick="javascript: formName.action='memberModify.lol'"><i class="fas fa-user-edit"></i>&nbsp;정보수정</button>
	                                </div>
								</div>
                            </form>
		                </div>
