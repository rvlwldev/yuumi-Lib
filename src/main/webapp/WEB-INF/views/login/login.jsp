...
<div class="login-form">
			<form action="<%=request.getContextPath()%>/login/login.lol" method="post">
        <h2 class="text-center">로그인</h2>   
        <div class="form-group">
        	<div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" class="form-control" name="memId" id="memId" placeholder="사용자 아이디" required="required">				
            </div>
        </div>
		<div class="form-group">
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                <input type="password" class="form-control" id="memPass" name="memPass" placeholder="비밀번호" required="required">				
            </div>
        </div>        
        <div class="form-group">
        ...
        <div class="clearfix">
            ...
            <input type="checkbox" name="idRemember" id="idRemember"> Remember me</label>
            <a href="#" class="pull-right">비밀번호 찾기</a>
        </div>
		<div class="or-seperator"></div>      
    </form>
    <p class="text-center text-muted small">아직 회원이 아니십니까? <a href="<%=request.getContextPath() %>/member/memberForm.lol">회원가입</a></p>
</div>
</div> --%>
